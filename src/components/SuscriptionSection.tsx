      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
        ...
        <div className="bg-white rounded-lg overflow-hidden shadow-md">
          ...
          <div className="px-4 pb-4">
            <button className="w-full bg-[#20c9ca] hover:bg-[#1ab9ba] text-black py-2 rounded transition-colors">
              Ver detalles
            </button>
          </div>
        </div>
      ...
      <div className="bg-white/10 backdrop-blur-md rounded-xl border border-white/20 shadow-2xl p-8 max-w-md w-full mx-4">
        <div className="text-center text-white">
          ...
          <div className="flex flex-col items-center sm:flex-row sm:justify-center gap-2 mb-4">
            ...
            <button className="bg-[#20c9ca] hover:bg-[#1ab9ba] text-black px-6 py-2 rounded-md font-medium transition-all hover:shadow-lg">
              Suscríbete
            </button>
          </div>
