          ...
          <div className="grid grid-cols-2 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6 md:gap-8">
            ...
            <div className="col-span-1">
              ...
              <ul className="space-y-2 text-sm">
                ...
                <li><Link href="/qa" className="text-gray-400 hover:text-white transition-colors">Q&A</Link></li>
          ...
          <div className="mt-8 pt-6 border-t border-gray-700">
            <div className="flex flex-col md:flex-row justify-between items-center">
              ...
              <div className="flex flex-wrap justify-center md:justify-end gap-y-2 gap-x-4 md:gap-x-6 text-xs text-gray-400">
                ...
                <Link href="/terminos-y-condiciones" className="hover:text-[#20c9ca] transition-colors whitespace-nowrap">
